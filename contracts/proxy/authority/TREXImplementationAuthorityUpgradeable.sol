...
contract TREXImplementationAuthorityUpgradeable is ITREXImplementationAuthority, OwnableUpgradeable {
    ...
    /**
     * @notice Initializes the TREXImplementationAuthorityUpgradeable contract
     * @param referenceStatus boolean value determining if the contract is the main IA or an auxiliary contract
     ...
     */
    function initialize(bool referenceStatus, address trexFactory, address iaFactory) external initializer {
        __TREXImplementationAuthorityUpgradeable_init(referenceStatus, trexFactory, iaFactory);
    }
    ...
    function changeImplementationAuthority(address _token, address _newImplementationAuthority) external override {
        ...
        if(
            OwnableUpgradeable(_token).owner() != msg.sender
            || OwnableUpgradeable(_ir).owner() != msg.sender
            || OwnableUpgradeable(_mc).owner() != msg.sender
            || OwnableUpgradeable(_irs).owner() != msg.sender
            || OwnableUpgradeable(_ctr).owner() != msg.sender
            || OwnableUpgradeable(_tir).owner() != msg.sender) {
    ...
    /**
     * @dev Initializes the TREXImplementationAuthorityUpgradeable contract.
     * @param referenceStatus boolean value determining if the contract is the main IA or an auxiliary contract
     * @param trexFactory the address of TREXFactory referencing the main IA
     * @param iaFactory the address for the factory of IA contracts
     */
    function __TREXImplementationAuthorityUpgradeable_init(
        bool referenceStatus,
        address trexFactory,
        address iaFactory
    ) internal onlyInitializing {
        __Ownable_init(msg.sender);
        __TREXImplementationAuthorityUpgradeable_init_unchained(referenceStatus, trexFactory, iaFactory);
    }

    /**
     * @dev Unchained initializer for the TREXImplementationAuthorityUpgradeable contract.
     * @param referenceStatus boolean value determining if the contract is the main IA or an auxiliary contract
     * @param trexFactory the address of TREXFactory referencing the main IA
     * @param iaFactory the address for the factory of IA contracts
     */
    function __TREXImplementationAuthorityUpgradeable_init_unchained(
        bool referenceStatus,
        address trexFactory,
        address iaFactory
    ) internal onlyInitializing {
